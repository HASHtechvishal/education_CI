...
<?= $this->section('pageTitle') ?>MEETINGS<?= $this->endsection() ?>
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="meeting-details.html"><img src="<?php echo base_url('front/assets/images/meeting-01.jpg')?>" alt=""></a>
                    </div>
                ...
                <div class="col-lg-4 templatemo-item-col all imp">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="meeting-details.html"><img src="<?php echo base_url('front/assets/images/meeting-02.jpg')?>" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="meeting-details.html"><img src="<?php echo base_url('front/assets/images/meeting-03.jpg')?>" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                ...
                <div class="col-lg-4 templatemo-item-col all att">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="meeting-details.html"><img src="<?php echo base_url('front/assets/images/meeting-04.jpg')?>" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
